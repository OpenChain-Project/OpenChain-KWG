...
<div class="url-link">🔗 <a href="https://openchain-project.github.io/OpenChain-KWG/guide/tools/cdxgen-dependency-track/">cdxgen + Dependency-Track 구축 가이드</a></div>
...
<div class="evidence">입증자료: <br>-ISO/IEC 5230 §3.1.2.2 역할별 역량 정의 문서</div>
<div class="url-link">🔗 <a href="https://openchain-project.github.io/OpenChain-KWG/guide/opensource_for_enterprise/5-training/">오픈소스 관리 가이드: 교육</a></div>
...
<!-- 슬라이드 76: OpenChain AI-BOM 가이드 소개 -->
...
<div class="b-body">프로세스 문서 완성 · 도구 CI/CD 연동 · openchainproject.org/conformance-submission 제출</div>
</div>
</div>
