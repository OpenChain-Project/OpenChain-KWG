...
<div class="callout callout-orange" style="font-size:19px; margin-top:12px;">
<small>⚠️ 단, 모델 릴리스 라이선스만으로 판단하지 말 것 — <strong>학습 데이터의 NC 여부</strong>와 <strong>base pretrained 모델의 라이선스</strong>를 반드시 별도 확인해야 합니다</small>
</div>
...
<div class="callout callout-green" style="font-size:19px; margin-top:12px;">
<small>⚠️ CC-BY-NC 데이터로 학습된 모델은 라이선스 표기와 무관하게 <strong>상업적 배포의 적법성이 불명확</strong>할 수 있습니다 — 데이터 출처와 라이선스를 AI-BOM에 반드시 기록하세요</small>
</div>
