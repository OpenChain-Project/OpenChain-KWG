...
ISO/IEC 5230 is a specification created by the OpenChain Project of the Linux Foundation and defines the minimum core requirements to ensure reliable open source compliance in the software supply chain.

Software today is growing in size and complexity. In order to develop one piece of software, not only self-developed software, but also various software across the software supply chain such as open source, third-party software, and vendor's SDK can be used.

If any one of the many organizations in this complex software supply chain fails to comply with their open source license obligations or fails to provide proper open source information, companies distributing end software will inevitably fail to comply with their open source license obligations. This may lead to lawsuits and the suspension of product sales.
