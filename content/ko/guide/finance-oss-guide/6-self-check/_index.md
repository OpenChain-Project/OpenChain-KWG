...
| 외주 계약에 SBOM·라이선스·취약점·권리 귀속 요구를 넣는다 | (전자금융감독규정 제21조 내부통제) | — | [사용 승인](../4-approve/#외주-계약과-제안요청서) |
...
자가점검 워크북을 산출물로 제공한다. 항목별로 충족 여부를 표시하고, 부족한 부분의 담당자와
기한을 적어 개선 계획으로 쓸 수 있다. 항목별 권장 도구는 이 페이지의 표에서 확인한다.
