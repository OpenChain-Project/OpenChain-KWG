...
| 새로 도입하는 오픈소스와 그 의존성을 빠짐없이 파악한다 | 5230 3.3.1.1 | [Syft](../../tools/6-syft/), [cdxgen](../../tools/5-cdxgen/) | [식별](../2-identify/) |
| 전이 의존성까지 펼쳐 식별한다 | 5230 3.3.1.1 | Syft, [OSV-SCALIBR](../../tools/4-osvscalibr/) | [식별](../2-identify/) |
| 이미 운영 중인 시스템의 레거시 오픈소스를 식별한다 | 5230 3.3.1.1 | [Trivy](https://trivy.dev/), [Dependency-Track](../../tools/7-dependency-track/) | [식별](../2-identify/#운영-중인-시스템의-식별) |
...
| 점검 항목 | 관련 ISO 입증자료 | 권장 도구 | 가이드 섹션 |
|------|------|------|------|
| SBOM의 각 컴포넌트에 알려진 취약점이 있는지 점검한다 | 18974 4.3.2.1 | Dependency-Track, [Grype](https://github.com/anchore/grype), Trivy | [이슈 파악·해결](../3-issue-resolve/) |
| 취약점에 위험 점수를 매기고 심각도별 대응 기한을 정한다 | 18974 4.3.2.1 | Dependency-Track, Grype | [이슈 파악·해결](../3-issue-resolve/#대응-기한) |
| 취약점 조치 결과를 기록한다(조치 불필요 판단 포함) | 18974 4.3.2.2 | Dependency-Track(VEX), 상용 SCA | [이슈 파악·해결](../3-issue-resolve/) |
| 라이선스 의무를 확인하고 충돌을 해결한다 | 5230 3.3.2.1 | [FOSSology](../../tools/1-fossology/), [SCANOSS](../../tools/9-scanoss/) | [이슈 파악·해결](../3-issue-resolve/#라이선스-이슈-해결) |
...
| 점검 항목 | 관련 ISO 입증자료 | 권장 도구 | 가이드 섹션 |
|------|------|------|------|
| 오픈소스 사용 승인 절차와 검토 주체가 정해져 있다 | 5230 3.1.5.1 | [SW360](../../tools/2-sw360/), Dependency-Track(정책) | [사용 승인](../4-approve/) |
...
| 점검 항목 | 관련 ISO 입증자료 | 권장 도구 | 가이드 섹션 |
|------|------|------|------|
| 운영 시스템의 SBOM을 등록해 지속적으로 취약점을 감시한다 | 18974 4.3.2 | Dependency-Track, CI 의존성 스캐닝, 상용 SCA | [관리](../5-manage/#지속-취약점-모니터링) |
| 신규 취약점 공개 시 영향받는 시스템을 역추적한다 | 18974 4.3.2 | Dependency-Track, 상용 SCA | [관리](../5-manage/#지속-취약점-모니터링) |
