...
description: >
  OpenChain Project의 배경과 ISO/IEC 5230 · 18974 국제 표준화 과정,
  표준 인증 방법, 글로벌 적용 추세를 정리합니다.
---
...
지난 6년간(2020-2026) 사실상의 표준이었던 OpenChain 규격이 ISO/IEC 5230:2020이라는 정식 국제 표준으로 전환되었고, 이는 오픈소스 컴플라이언스 및 프로세스 관리를 정의한 최초의 국제 표준입니다. 이로써 글로벌 IT기업의 ISO/IEC 5230 준수에 관한 관심이 높아지고 있고, 소프트웨어 공급망에서 공급자들에게 ISO/IEC 5230 준수를 요구하는 기업이 늘어날 것으로 예상됩니다.

2023년에는 오픈소스 보안 보증을 위한 새로운 표준인 [ISO/IEC 18974](https://www.iso.org/standard/86450.html)가 발표되었습니다. 이 표준은 OpenChain 보안 보증 규격을 기반으로 하며, 오픈소스 소프트웨어의 알려진 보안 취약점을 관리하기 위한 핵심 요구사항을 정의합니다. ISO/IEC 18974는 다음과 같은 주요 영역을 다룹니다:
...
|---------|-------------|-------------|-------------|
| **비용** | 무료 | 평가 기관별(견적) | 인증 기관별(견적) — 일반적으로 가장 높음 |
| **소요 기간** | 1-2주 (체크리스트 → Submission → Review → Listing) | 2-4주 (사전 평가 + 컨설팅 포함) | 4-12주 (문서·인터뷰·시정 라운드 포함) |
| **결과물** | OpenChain Conforming Submission Listing | 평가 보고서 + 컨설팅 의견 (인증서 미발급) | OpenChain 공인 인증서 + Listing |
| **갱신 주기** | 18개월 (셀프 재선언) | 평가 기관 계약에 따름 | 인증 기관 계약에 따름 (일반적으로 1-3년) |
| **시장 신뢰도** | 기본 신뢰도 (가장 보편적) | 컨설팅 보강 후 자체 또는 타사 인증으로 진행 권장 | 가장 높음 — 글로벌 공급망·규제 입찰에 유리 |
| **권장 대상** | 처음 도입하는 기업 · 내부 역량 충분 | 자가 평가 후 부족 부분 보완 필요 | 글로벌 공급망 · OEM 의무 요구 대응 |
...
2026년 5월 기준 OpenChain 공인 타사 인증 기관은 [ORCRO](https://orcro.co.uk/), [PWC](https://www.pwc.de/en/opensource), [TÜV SÜD](https://www.tuvsud.com/), [Black Duck](https://www.blackduck.com/)(Synopsys SIG에서 2024년 분사), [Bureau Veritas](https://group.bureauveritas.com/) 등이 있습니다. 최신 목록은 [OpenChain 공식 파트너 페이지](https://www.openchainproject.org/partners)에서 확인합니다.
...
OpenChain Project는 소프트웨어 공급망 전체에 걸친 오픈소스 컴플라이언스 신뢰 구축을
목표로 설립되었으며, OpenChain 규격은 ISO/IEC 5230(2020년) · ISO/IEC 18974(2023년)
두 국제 표준으로 정식 등록되었습니다.

이 섹션을 통해 기업은 다음과 같은 이점을 얻을 수 있습니다:

1. 오픈소스 컴플라이언스가 단순한 사내 규정이 아닌 글로벌 공급망 신뢰의 기반임을 이해
2. ISO/IEC 5230 · 18974 국제 표준화 배경과 OpenChain 규격과의 관계 파악
3. 자가 인증 · 독립 평가 · 제3자 인증 세 가지 방법의 차이와 적합 상황 결정
4. 글로벌 IT 기업과 국내 기업의 적용 추세 인식
5. 다음 섹션부터 다루는 구체적 준수 방법의 적용 맥락 확보

---

> **ISO/IEC 5230 / 18974 준수 가이드** — 이 섹션과 관련된 가이드:
...
> - [1. 조직](../1-teams/) — 오픈소스 프로그램 운영을 위한 역할과 책임
> - [6. 준수 선언](../6-conforming/) — 표준 요구사항 충족 확인 및 지속적 준수 보장