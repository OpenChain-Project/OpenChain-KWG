...
이러한 오픈소스 기여에 대한 정책은 [부록1] 오픈소스 정책 샘플 [7. 오픈소스 기여](../7-policy-template/#7-오픈소스-기여)에서 확인할 수 있습니다. 
...
오픈소스 정책을 문서화하는 것은 효과적인 오픈소스 관리를 위해 가장 중요한 과정입니다. 위의 내용을 참고하여 각 요구사항을 회사의 상황에 맞게 적절한 원칙을 수립하는 것이 필요합니다. 또한 문서로만 그치지 않고, 실행 가능한 절차까지 고려해야 합니다. 말뿐인 정책은 소용이 없습니다.
