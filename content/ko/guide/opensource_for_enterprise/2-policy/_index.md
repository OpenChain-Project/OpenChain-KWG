...
[부록1] 오픈소스 정책 (샘플)의 [6. 오픈소스 사용](../appendix/2-process-template/#6-오픈소스-사용)에서 이를 문서화한 원칙을 살펴보실 수 있습니다. 
...
이러한 오픈소스 기여에 대한 정책은 [부록1] 오픈소스 정책 샘플 [7. 오픈소스 기여](../appendix/2-process-template/#7-오픈소스-기여)에서 확인할 수 있습니다. 
