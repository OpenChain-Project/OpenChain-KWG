...
* 4.4.1.1: Documented Evidence affirming the Program specified in §4.1.4 satisfies all the requirements of this document.<br>`§4.1.4에 명시된 프로그램이 이 문서의 모든 요구 사항을 충족함을 확인하는 문서화된 증거.`
...
ISO/IEC 5230과 ISO/IEC 18974는 또한 적합성 인증 획득 후 **지난 18개월 동안** 모든 요구사항을 **충족해 왔음**을 확인하는 회고형 문서를 요구합니다 (미래형 보장 선언이 아닌 과거 사실 확인 문서):
...
* 4.4.2.1: A document affirming the Program meets all the requirements of this specification, within the past 18 months of obtaining conformance validation.<br>`프로그램이 적합성 인증을 획득한 후 지난 18개월 동안 이 규격의 모든 요구사항을 충족하고 있음을 확인하는 문서`
...
```
[회사명]은 ISO/IEC 5230:2020(오픈소스 라이선스 컴플라이언스)과 ISO/IEC 18974(오픈소스 보안 보증)의 적합성 인증을 획득한 후 **지난 18개월 동안** 모든 요구사항을 **지속적으로 충족해 왔음**을 확인합니다. 다음 재확인 예정일: [YYYY-MM-DD]. 18개월 주기 미준수 시 적합성 인증 효력이 상실될 수 있습니다.
