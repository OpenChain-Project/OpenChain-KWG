...
{{% alert title="표기 규칙 — [ISO 요구] vs [본 가이드 권고]" color="info" %}}
...
{{% alert title="다른 표준과의 관계" color="info" %}}

ISO/IEC 18974는 ISO/IEC 5230(라이선스 컴플라이언스)·42001(AI 관리 시스템)과 함께 통합 운영할 수 있다.

- **ISO/IEC 5230 선행 권장**: 18974 16개 일반 항목은 ISO 5230 대응 항목을 기반으로 파생됩니다.
  먼저 [ISO/IEC 5230 준수 가이드](../iso5230_guide/)로 기반을 구축할 것을 권장합니다.
- **ISO/IEC 42001 통합**: AI 시스템 보안 보증은 ISO 42001 §6.1.2(AI 리스크 평가)와 직접 연계됩니다.
  AI 컴플라이언스 통합 시각은 [ISO/IEC 42001 가이드](../iso42001_guide/)와
  [기업 가이드 — AI 컴플라이언스](../opensource_for_enterprise/7-ai-compliance/) 참고.
- **세 표준 비교**: [ISO 5230 · 18974 · 42001 표준 비교](../iso42001_guide/compare/)에서
  세 표준의 관계와 동시 운영 시 공통 기반을 확인할 수 있습니다.
