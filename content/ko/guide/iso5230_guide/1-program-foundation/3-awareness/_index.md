...
ISO/IEC 5230 §3.1.3은 다음 **4가지** 인식 요소를 요구한다(원문 4 bullet과 정합).

- **(1) 오픈소스 정책의 존재 및 위치**: 참여자가 회사의 오픈소스 정책 문서가 존재한다는
  사실과 어디에서 찾을 수 있는지(사내 포털 URL 등)를 인지하고 있는지 평가한다.
- **(2) 프로그램 목표**: 참여자가 오픈소스 프로그램의 목표(라이선스 컴플라이언스,
  보안 보증 등)를 이해하고 있는지 확인한다.
- **(3) 자신의 기여 방법**: 각 참여자가 자신의 역할이 전체 프로그램 운영에 어떻게
  기여하는지 인식하고 있는지 평가한다.
- **(4) 미준수 영향**: 프로그램 요구사항을 미준수할 경우 발생할 수 있는 법적·사업적
...
프로그램 참여자가 **4가지 핵심 내용**을 인식하고 있음을 평가하고 결과를 기록해야 한다.
4가지 핵심 내용은 ①**오픈소스 정책의 존재와 위치**(사내 포털 URL 등), ②프로그램의
목표(오픈소스 라이선스 컴플라이언스 및 보안 보증), ③자신의 역할이 프로그램에
기여하는 방법, ④프로그램을 준수하지 않을 경우 발생하는 법적·사업적 영향이다. ISO 원문
영문 bullet 4개와 정확히 정합하며, ①(정책 존재·위치)이 누락되면 §3.1.3.1 ⚠️ 판정
위험이 있다.
...
|------|------|-----------|-----------|------|--------|------|
| 홍길동 | 오픈소스 프로그램 매니저 | (1) 정책 존재·위치 인식 | 온라인 퀴즈 | 완료 (100점) | 2026-01-15 | 사내 포털 URL 응답 |
| 홍길동 | 오픈소스 프로그램 매니저 | (2) 프로그램 목표 이해 | 온라인 퀴즈 | 완료 (90점) | 2026-01-15 | - |
| 홍길동 | 오픈소스 프로그램 매니저 | (3) 자신의 기여 방법 | 인터뷰 | 완료 | 2026-01-15 | 면담 기록 |
| 홍길동 | 오픈소스 프로그램 매니저 | (4) 미준수 영향 인식 | 온라인 퀴즈 | 완료 (90점) | 2026-01-15 | - |
| 김철수 | 개발자 | (1) 정책 존재·위치 인식 | 온라인 퀴즈 | 완료 (90점) | 2026-01-20 | - |
| 김철수 | 개발자 | (2) 프로그램 목표 이해 | 온라인 퀴즈 | 완료 (85점) | 2026-01-20 | - |
| 이영희 | 보안 담당 | (3) 자신의 기여 방법 인식 | 인터뷰 | 완료 | 2026-01-22 | 면담 기록 보관 |
```
