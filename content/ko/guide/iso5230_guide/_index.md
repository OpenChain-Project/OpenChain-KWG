...
각 조항 페이지의 내용은 다음 두 가지로 구분된다. 인증 심사 시 두 표기의 차이를 정확히
인지하면 불필요한 지적을 피할 수 있다.
...
- **ISO/IEC 18974 추가 준비**: ★ 9개 추가 항목만 보강하면 18974 자가 인증이 가능하다.
  자세한 안내는 [ISO/IEC 18974 준수 가이드](../iso18974_guide/) 참고.
- **ISO/IEC 42001 통합**: AI 시스템을 개발·운영하는 조직은 AI 관리 시스템 표준
  ISO/IEC 42001과 통합 운영하는 것이 효율적이다. AI SBOM·AI 라이선스·외부 AI 모델 조달 등
  교차 영역은 [ISO/IEC 42001 가이드](../iso42001_guide/)에서 다룬다.
