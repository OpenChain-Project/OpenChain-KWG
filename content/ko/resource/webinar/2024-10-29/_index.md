...
이렇게 많은 컴포넌트를 관리하는 것은 복잡한 작업입니다. 라이선스 의무, 보안 취약점, 수출 제한, 운영 위험 등 다양한 측면을 고려해야 합니다. 기존의 리스트 형태의 SBOM으로는 이러한 복잡성을 효과적으로 관리하기 어렵습니다.
...
발표자는 [Google Chromium](https://www.chromium.org/) 프로젝트를 예로 들어 SBOM 시각화 도구의 실제 적용을 보여주었습니다. Chromium은 수많은 컴포넌트로 구성된 대규모 프로젝트입니다.

### 시각화 예시
- 전체 뷰: 처음에는 복잡해 보이지만, 필터링과 검색, 확대/축소 기능을 통해 쉽게 탐색할 수 있습니다.
