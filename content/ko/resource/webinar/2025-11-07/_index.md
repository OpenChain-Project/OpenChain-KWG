---
title: "2025-11-07 컨테이너와 오픈소스 컴플라이언스: 무엇이 문제이고 어떻게 해결할 것인가?"
linkTitle: "2025-11-07"
# weight: 10
date: 2025-11-07
type: docs
categories: ["webinar"]
...
컨테이너는 기본적으로 이미 빌드된 '바이너리(Binary)' 형태의 이미지입니다. 소스 코드가 없는 상태에서 바이너리만 보고 라이선스를 판별하는 것은 기술적으로 어렵습니다.
