...
- src: "**.{png,jpg}"
  ...
  params:
    byline: ""
aliases:
  - /blog/2021/11/15/중국-첫-gpl-소송-사례-virtualapp/
---
...
4. 그런데, 2017년 1월 24일, 갑자기 "[당신은 이 프로젝트를 무료로 사용할 수 있는 권한이 없다](https://github.com/asLody/VirtualApp/commit/7c8bfa40b2b301828cbaafefca122a3b5fc141d9)"는 안내가 추가됩니다. 
   ...
   * 다만, 이렇게 GPL로 공개한 오픈소스에 조건을 추가하는건 GPL에서 허용하지 않은 방식인데요, Lody는 오픈소스 라이선스를 제대로 이해하지 못하고 있었기 때문에 GPL-3.0에 위반하는 라이선싱 정책을 시도한 것으로 보인다고 중국 변호사는 언급한 바 있습니다. 
