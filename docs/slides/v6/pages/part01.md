...
<!--
  Part 0 도입 + Part 1 ISO 표준 이해
  컴포넌트: Callout · StepFlow · StandardCompare · HexCoreElements
  표지는 slides.md 의 oc-cover 슬라이드(중복 제거됨).
-->

<div class="oc-consult__kicker">Introduction</div>
...
<div class="oc-card">
<div class="oc-card__label">우리가 이미 아는 것</div>
...
<div class="oc-card">
<div class="oc-card__label">이 강의가 더하는 것</div>
...
<div class="oc-card__label">이 강의의 기준</div>
<div class="oc-card__text">오픈소스 관리는 개인 역량이 아니라 <strong>조직의 관리 체계</strong>다. 적은 리소스로 적정 수준의 리스크를 관리하는 것이 목표다.</div>
</div>

</div>

<div class="oc-consult__source">
  <span>Source: OpenChain General Public Guide</span>
  <span>OpenChain KWG</span>
</div>
...
<div class="oc-card">
<div class="oc-card__label">소송·공급망 리스크는 실재한다</div>

- **2009 BusyBox(GPL-2.0) 소송** — 국내 2곳 포함 14개 사 피소. 직접 개발하지 않고 **배포만 한 회사도 대상**
- 복잡한 공급망에선 한 기업이 완벽해도 단독 달성은 어렵다
- 결국 **공급망 전체의 신뢰**가 필요 — OpenChain의 출발점

</div>

<div class="oc-card">
<div class="oc-card__label">핵심 메시지</div>
<div class="oc-card__text">오픈소스 컴플라이언스는 기업 이익을 차별화하는 분야가 아니다. 모두가 자산을 공유할수록, 적은 리소스로 함께 달성한다.</div>
</div>

</div>

<div class="oc-consult__source">
  <span>Source: OpenChain License Compliance General Public Guide</span>
  <span>OpenChain KWG</span>
</div>
...
<div class="oc-card">
<div class="oc-card__label">01</div>
<h3>표준 이해</h3>
<div class="oc-card__text">ISO/IEC 5230 · 18974 · 42001 세 표준의 목적과 입증자료 셈법을 명확히</div>
</div>

<div class="oc-card">
<div class="oc-card__label">02</div>
<h3>체계 구축</h3>
<div class="oc-card__text">조직·정책·프로세스·도구·교육·준수 — <strong>6대 핵심 요소</strong>를 단계별로</div>
</div>

<div class="oc-card">
<div class="oc-card__label">03</div>
<h3>첫 액션</h3>
<div class="oc-card__text">AI 컴플라이언스까지 확장, 라이브 데모로 <strong>오늘 바로 시작</strong></div>
</div>

</div>

<div class="oc-consult__source">
  <span>OpenChain KWG · 강의 목표</span>
</div>
...
<div class="oc-lead">총 4시간(240분) · 6개 파트</div>
...
<div class="oc-section__num">Part 1</div>

# ISO 표준 이해

<div class="oc-section__sub">5230 · 18974 · 42001, 그리고 입증자료 셈법 — 30분</div>
...
<div class="oc-consult__kicker">ISO Standards · OpenChain</div>
...
<div class="oc-card">
<div class="oc-card__label">개요</div>

- **Linux Foundation**이 운영하는 프로젝트
- 2016년 시작 — 퀄컴·지멘스·ARM·어도비 등 참여
- 컴플라이언스 **핵심 요구사항을 간결·일관되게** 정의

</div>

<div class="oc-card">
<div class="oc-card__label">세 가지 제공물</div>
...
<div class="oc-card oc-card--wide">
<div class="oc-card__label">공급망 철학</div>
<div class="oc-card__text">한 기업의 수준을 높이려면 공급망 내 모든 구성원의 수준을 높여야 한다. 선진 기업이 자산을 공개해 누구나 참고하도록 한다.</div>
</div>

</div>

<div class="oc-consult__source">Source: OpenChain Project</div>
...
<div class="oc-consult__kicker">ISO Standards · ISO/IEC 5230</div>
...
- OpenChain 규격 **v2.1** → 2020.12 **ISO/IEC 5230:2020** 등록
- **오픈소스 컴플라이언스 최초의 국제 표준**
- 기업 규모·업종 무관하게 적용 가능
- 공급망의 5230 준수 요구 증가 (Scania, Bosch 등)

</div>

<div class="oc-card">
<div class="oc-card__label">ISO/IEC 5230:2020 · OpenChain v2.1</div>
<div class="oc-card__text">오픈소스 컴플라이언스 달성을 위해 갖춰야 할 <strong>6대 핵심 요구사항</strong>과 이를 입증하는 <strong>입증자료 25개</strong>를 정의한다.</div>
</div>

</div>

<div class="oc-consult__source">Source: ISO/IEC 5230:2020</div>
...
<div class="oc-lead">처음 시작하는 기업은 6대 요구사항을 하나씩 충족하며 수준을 높인다 — Part 2에서 단계별 구축</div>
...
<div class="oc-consult__source">§3.1 프로그램 기반 · §3.2 관련 업무 · §3.3 콘텐츠 검토 · §3.4 산출물 · §3.5 커뮤니티 · §3.6 준수</div>
...
<div class="oc-lead">13개 조항 / 25개 항목 — 본 가이드 기준 전 항목 충족 가능</div>
...
<div class="oc-consult__source">§3.1(8) · §3.2(7) · §3.3(3) · §3.4(2) · §3.5(3) · §3.6(2) = 25개 · 상세는 Part 2</div>
...
<div class="oc-consult__kicker">ISO Standards · ISO/IEC 18974</div>

# 보안 보증 — 5230과 짝을 이루는 표준
...
- 2023년 발표 — **OpenChain Security Assurance** 기반
- 오픈소스 **알려진 보안 취약점** 관리 요구사항 정의
- 5230 위에 **탐지·평가·대응 보안 레이어** 추가
- 정책·역량·SBOM 등 핵심 인프라를 5230과 **공유**

</div>

<div class="oc-card">
<div class="oc-card__label">ISO/IEC 18974:2023</div>
<div class="oc-card__text">보안 프로세스 영역 식별 · 역할과 책임 할당 · 지속 가능성 보장. 5230이 라이선스라면 18974는 <strong>보안 취약점 관리</strong>에 초점을 둔 상호 보완 표준이다.</div>
</div>

</div>

<div class="oc-consult__source">Source: ISO/IEC 18974:2023 (OpenChain Security Assurance)</div>
...
# 입증자료 셈법 — 공통 16 파생 · 전용 9 강화

<div class="oc-consult__body oc-bento oc-bento--2">

<div class="oc-card">
<div class="oc-card__label">18974 = 25개 (5230과 동수)</div>

- **16개** — 5230 대응 항목 기반 파생 (보안 관점 추가 작성 필요)
- **9개 ★** — 18974 전용 보안 특화 항목

<div class="oc-card__text" style="margin-top:0.6rem;font-family:var(--oc-font-mono)">★ 4.1.2.3 · 4.1.2.5 · 4.1.2.6 · 4.1.4.2 · 4.1.4.3 · 4.1.5.1 · 4.2.2.3 · 4.3.2.1 · 4.3.2.2</div>

</div>

<div class="oc-card">
<div class="oc-card__label">강도 차이 주의</div>
<div class="oc-card__text">★ 9개 전용 항목은 단순 <code>document</code>보다 한 단계 강한 <strong>Documented Evidence(문서화된 증거)</strong>를 요구한다. 예: §4.1.5 8가지 취약점 처리 방법, §4.3.2 탐지·해결 절차.</div>
</div>

</div>

<div class="oc-consult__source">Source: ISO/IEC 18974:2023 · 전용 항목 §4.1.5 · §4.3.2</div>
...
<div class="oc-consult__kicker">ISO Standards · ISO/IEC 42001</div>
...
- 2023년 발행 — AI를 책임감 있게 운영하는 **AI 관리 시스템** 표준
- 제정: **ISO/IEC JTC 1/SC 42** (OpenChain과 무관)
- ISO 9001·27001과 **동일한 경영 시스템 구조**(PDCA)
- 입증자료 번호 없음 — **shall 요구사항** 방식

</div>

<div class="oc-card">
<div class="oc-card__label">오픈소스 관점의 42001</div>
<div class="oc-card__text">이 강의는 42001 전체가 아니라 <strong>오픈소스와 교차하는 6개 조항</strong>(§5.2·6.1.2·7.5·8.5·8.6·8.8)에 집중 — AI 프레임워크·모델·데이터셋·AI SBOM·공급망 검증.</div>
</div>

</div>

<div class="oc-consult__source">Source: ISO/IEC 42001:2023</div>
...
<div class="oc-consult__kicker">ISO Standards · 비교</div>
...
<div class="oc-consult__source">Source: ISO/IEC 5230 · 18974 · 42001</div>
...
<div class="oc-card">
<div class="oc-card__label">01 · 자체 갭 분석</div>
<div class="oc-card__text">각 shall 조항을 내부 검토해 수준 평가·개선 계획 수립. <strong>무료</strong> · 이 가이드 체크포인트 활용</div>
</div>

<div class="oc-card">
<div class="oc-card__label">02 · 제2자 심사</div>
<div class="oc-card__text">고객사·파트너사가 직접 AI 관리 시스템 평가. 공급망 신뢰 구축 목적</div>
</div>

<div class="oc-card">
<div class="oc-card__label">03 · 제3자 인증</div>
<div class="oc-card__text">BSI·TÜV SÜD 등 인증기관이 공식 인증서 발급. ISO 27001과 동일 방식</div>
</div>

<div class="oc-card oc-card--wide">
<div class="oc-card__label">ISO/IEC 42006 동향</div>
<div class="oc-card__text">42001 <strong>인증기관 요건</strong>을 정의하는 ISO/IEC 42006이 개발 중. 정비되면 제3자 인증의 일관성·신뢰도가 높아진다.</div>
</div>

</div>

<div class="oc-consult__source">Source: ISO/IEC 42001 · 42006 (개발 중)</div>
...
<div class="oc-consult__kicker">OpenChain · Self-Certification</div>

# 자가 인증의 3단계

<div class="oc-lead">1–2주, 비용 없이 ISO/IEC 5230 적합성을 선언하는 가장 빠른 경로</div>

<div class="oc-consult__body oc-bento">

<div class="oc-card oc-card--wide">
<div class="oc-card__label">Process</div>

<StepFlow :steps="[
  { label: '체크리스트 작성', note: '공식 질문 세트' },
  { label: '모든 질문 Yes', note: 'No면 제출 불가' },
  { label: 'Conforming 제출' },
  { label: 'LF 검토', note: '영업일 5–10일' },
  { label: 'Listing 등재', note: '5230 적합 선언' },
]" />

</div>

<div class="oc-card">
<span class="oc-stat">1–2<span style="font-size:0.4em;font-weight:500"> 주</span></span>
<div class="oc-card__label">전체 소요 기간</div>
</div>

<div class="oc-card">
<span class="oc-stat">$0</span>
<div class="oc-card__label">인증 비용</div>
</div>

<div class="oc-card">
<div class="oc-card__label">권장 경로</div>
<div style="font-size:var(--oc-text-small);line-height:1.45;color:var(--oc-ink)">대부분의 기업이 자가 인증 채택 — 점검 과정에서 <strong>부족한 부분을 스스로 발견</strong></div>
</div>

</div>

<div class="oc-consult__source">
  <span>Source: OpenChain Project, Self-Certification Guidelines (2024)</span>
  <span>OpenChain KWG</span>
</div>
...
<div class="oc-lead">자가 점검 시 각 입증자료를 ✓ / △ / ✗ 로 판정한다</div>
...
자가 인증 체크리스트는 모든 질문에 <strong>Yes</strong>일 때만 제출할 수 있다. △·✗ 항목을 먼저 ✓로 끌어올려야 한다.
</Callout>

</div>

<div class="oc-consult__source">△·✗를 ✓로 끌어올리는 것이 준비의 전부 · 본 가이드 EVIDENCE-CHECK 활용</div>
...
<div class="oc-consult__kicker">Part 1 · 인증 효과</div>
...
<div class="oc-card">
<div class="oc-card__label">공급망 신뢰</div>

- Global Software Supply Chain에서 **5230 준수 기업** 인정
- 구매자(Scania STD 4589·Bosch) 준수 요구 대응
- OEM·규제 입찰에서 **차별화 요소**

</div>

<div class="oc-card">
<div class="oc-card__label">리스크 대응</div>

- 라이선스 위반·소송 리스크 **체계적 관리**
- 18974 추가 시 **보안 취약점 대응** 보증
- 국내: KT 2024.10 **ISO/IEC 18974 인증** 획득

</div>

<div class="oc-card oc-card--wide">
<div class="oc-card__label">단계적 확장</div>
<div class="oc-card__text">자가 인증만으로도 많은 공급망 파트너 요구를 충족. 이후 <strong>독립 평가 → 제3자 인증</strong>으로 신뢰도를 높인다.</div>
</div>

</div>

<div class="oc-consult__source">Scania STD 4589 · Bosch · KT (2024.10 ISO/IEC 18974)</div>
...
<div class="oc-consult__kicker">Part 1 · 요약</div>
...
<div class="oc-card">
<div class="oc-card__label">세 표준 · 인증</div>

- **ISO/IEC 5230** 라이선스 컴플라이언스 (2020)
- **ISO/IEC 18974** 보안 보증 (2023)
- **ISO/IEC 42001** AI 관리 시스템 (2023)

5230·18974: 자가 인증(무료) → 독립 → 제3자 · 42001: 갭분석/제2자/제3자

</div>

<div class="oc-card">
<div class="oc-card__label">입증자료 셈법 — 전 덱 통일</div>
<span class="oc-stat">50</span>
<div class="oc-card__text">5230 <strong>25</strong> + 18974 <strong>25</strong> = 50. 18974의 16개는 5230 항목에서 <strong>파생</strong>, 9개(★)는 보안 <strong>전용</strong>. 42001은 번호 체계가 없어 제외.</div>
</div>

</div>

<div class="oc-consult__source">5230 25 + 18974 25 (공통 16 파생 · 전용 9) · 42001 별도 체계</div>
